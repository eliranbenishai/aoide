...
- **Move / snap ownership** — each title-bar drag moves only that panel. Snap only from EQ/playlist: EQ any side of any panel; playlist **top/bottom only**, with left/right flush when already within threshold. Details: [`2026-08-09-ui-polish-docking-taskbar-design.md`](superpowers/specs/2026-08-09-ui-polish-docking-taskbar-design.md).
