...
**Qt 6 C++** is the only build. One process, one frameless **host window**, six **panel** views, QWidget + QPainter in [`src/`](../src/). Binary: `build/aoide`.
