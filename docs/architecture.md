...
- Main and EQ: fixed logical canvases (**825×348**) sized by **global** discrete zoom only; playlist freely resizes (default **825×696**); settings fixed **520×420**; about fixed **380×220** ([ADR 0002](adr/0002-fixed-canvas-zoom.md))
