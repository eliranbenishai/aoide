...
- **Graphite skin PNGs** — product direction locked (ADRs 0003/0004, skin delivery design); mode-aware window sizing has landed (EQ zoom-only, playlist free resize + persisted size), but panel faces are still painted chrome until the skin tasks land.
