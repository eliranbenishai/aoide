...
- **Audible EQ / real spectrum still gated** — full libmpv load path is wired on Windows (fetch + CMake override + `LibmpvBundle.verify`); measurement gate and `EqualizerSink` / spectrum analyser remain ([ADR 0005](adr/0005-full-libmpv.md)).
